...
(() => {
  ...
  //   -> FULLSCREEN + remove locked + ẩn overlay + resume AudioContext + play <audio>
  // =========================================================
  ...
  // =========================================================
  // [ADD] Fullscreen helper (chạy trong user-gesture)
  // =========================================================
  function enterFullscreen() {
    try {
      // đã fullscreen thì thôi
      if (document.fullscreenElement || document.webkitFullscreenElement || document.msFullscreenElement) return;

      // bạn có thể đổi sang: const el = canvas; nếu muốn fullscreen riêng canvas
  ...
  function unlockPage() {
    ...
    // [ADD] Bấm nút là vào full screen luôn
    enterFullscreen();
  ...
  // ---------- Controls ----------
  if (soundBtn) {
    // Khi đang khóa: bấm soundBtn sẽ mở khóa + fullscreen
  ...
  addEventListener('keydown', (e) => {
    ...
    // phím M đồng bộ với mp3 + hỗ trợ mở khóa (+ fullscreen khi đang khóa)
